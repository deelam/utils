...
public class AbstractCompConfig {
  ...
  public String useRequiredProperty(Properties props, String propkey) {
    ...
    if(val==null)
      throw new IllegalArgumentException("Missing required config: "+propkey+"  props="+props);
    props.remove(propkey);
    return val;
  }
  ...
  public String useRequiredRefProperty(Properties props, String propkey) {
    ...
    if(resolvedVal==null)
      throw new IllegalArgumentException("Missing required config: "+refPath+"  props="+props);
